...
#include "AstralMappableConfigPair.generated.h"
...
struct UE_DEPRECATED(5.3, "FLoadedMappableConfigPair has been deprecated. Please use FInputMappingContextAndPriority instead.") FLoadedMappableConfigPair
{
	...
	FLoadedMappableConfigPair(const UPlayerMappableInputConfig* InConfig, const ECommonInputType InType, const bool InIsActive)
		: Config(InConfig)
		, Type(InType)
