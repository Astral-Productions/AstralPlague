...
#include "AstralGameplayCueManager.generated.h"
 ...
 */
UCLASS()
class UAstralGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UAstralGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UAstralGameplayCueManager* Get();
