...
#include "AstralCharacterGameplayComponent.generated.h"
...
public:
	...
	UAstralCharacterGameplayComponent(const FObjectInitializer& ObjectInitializer);

	/** Returns the hero component if one exists on the specified actor. */
	UFUNCTION(BlueprintPure, Category = "Astral|Hero")
	static UAstralCharacterGameplayComponent* FindGameplayComponent(const AActor* Actor) { return (Actor ? Actor->FindComponentByClass<UAstralCharacterGameplayComponent>() : nullptr); }
