...
#include "AstralGameFeaturePolicy.generated.h"
...
class UAstralGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	ASTRALPLAGUE_API static UAstralGameFeaturePolicy& Get();

	UAstralGameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
...
// checked
UCLASS()
class UAstralGameFeature_AddGameplayCuePaths : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
