...
#include UE_INLINE_GENERATED_CPP_BY_NAME(AstralExperienceDefinition)

#define LOCTEXT_NAMESPACE "AstralSystem"
...
#if WITH_EDITOR
EDataValidationResult UAstralExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UAstralExperienceDefinition::UpdateAssetBundleData()
{
