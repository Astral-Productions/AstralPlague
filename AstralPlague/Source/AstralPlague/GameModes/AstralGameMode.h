 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnAstralGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class AAstralGameMode : public AModularGameModeBase
{
	GENERATED_BODY()
...
public:
	...
	FOnAstralGameModePlayerInitialized OnGameModePlayerInitialized;
