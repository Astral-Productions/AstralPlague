...
#include "AstralCameraMode_ThirdPerson.generated.h"
...
class UAstralCameraMode_ThirdPerson : public UAstralCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FAstralPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
