...
#include "AstralPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FAstralPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FAstralPenetrationAvoidanceFeeler()
	...
	FAstralPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
