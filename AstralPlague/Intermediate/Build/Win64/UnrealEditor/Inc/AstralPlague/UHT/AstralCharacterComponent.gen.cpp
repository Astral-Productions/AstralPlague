...
// Begin Class UAstralCharacterComponent Function FindHeroComponent
struct Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics
{
	struct AstralCharacterComponent_eventFindHeroComponent_Parms
	{
		const AActor* Actor;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::NewProp_Actor = { "Actor", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AstralCharacterComponent_eventFindHeroComponent_Parms, Actor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Actor_MetaData), NewProp_Actor_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AstralCharacterComponent_eventFindHeroComponent_Parms, ReturnValue), Z_Construct_UClass_UAstralCharacterComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ReturnValue_MetaData), NewProp_ReturnValue_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::NewProp_Actor,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAstralCharacterComponent, nullptr, "FindHeroComponent", nullptr, nullptr, Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::AstralCharacterComponent_eventFindHeroComponent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::AstralCharacterComponent_eventFindHeroComponent_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UAstralCharacterComponent::execFindHeroComponent)
{
	P_GET_OBJECT(AActor,Z_Param_Actor);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(UAstralCharacterComponent**)Z_Param__Result=UAstralCharacterComponent::FindHeroComponent(Z_Param_Actor);
	P_NATIVE_END;
}
// End Class UAstralCharacterComponent Function FindHeroComponent
...
void UAstralCharacterComponent::StaticRegisterNativesUAstralCharacterComponent()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "FindHeroComponent", &UAstralCharacterComponent::execFindHeroComponent },
	};
...
struct Z_Construct_UClass_UAstralCharacterComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UAstralCharacterComponent_FindHeroComponent, "FindHeroComponent" }, // 2355388143
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_NovaB_Desktop_AstralPlague_AstralPlague_Source_AstralPlague_Components_AstralCharacterComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAstralCharacterComponent, UAstralCharacterComponent::StaticClass, TEXT("UAstralCharacterComponent"), &Z_Registration_Info_UClass_UAstralCharacterComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAstralCharacterComponent), 435578337U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_NovaB_Desktop_AstralPlague_AstralPlague_Source_AstralPlague_Components_AstralCharacterComponent_h_966020316(TEXT("/Script/AstralPlague"),
	Z_CompiledInDeferFile_FID_Users_NovaB_Desktop_AstralPlague_AstralPlague_Source_AstralPlague_Components_AstralCharacterComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_NovaB_Desktop_AstralPlague_AstralPlague_Source_AstralPlague_Components_AstralCharacterComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
