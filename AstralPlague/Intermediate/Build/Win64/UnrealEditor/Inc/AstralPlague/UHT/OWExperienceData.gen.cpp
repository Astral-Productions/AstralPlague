...
struct Z_CompiledInDeferFile_FID_AstralPlague_Source_AstralPlague_OpenWorld_Data_OWExperienceData_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOWExperienceData, UOWExperienceData::StaticClass, TEXT("UOWExperienceData"), &Z_Registration_Info_UClass_UOWExperienceData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOWExperienceData), 3782777211U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_AstralPlague_Source_AstralPlague_OpenWorld_Data_OWExperienceData_h_2764043821(TEXT("/Script/AstralPlague"),
