...
ASTRALPLAGUE_API UClass* Z_Construct_UClass_UGameFeatureAction_AddInputContextMapping();
ASTRALPLAGUE_API UClass* Z_Construct_UClass_UGameFeatureAction_AddInputContextMapping_NoRegister();
...
class UScriptStruct* FInputMappingContextAndPriority::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InputMappingContextAndPriority.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInputMappingContextAndPriority, (UObject*)Z_Construct_UPackage__Script_AstralPlague(), TEXT("InputMappingContextAndPriority"));
	}
	return Z_Registration_Info_UScriptStruct_InputMappingContextAndPriority.OuterSingleton;
}
template<> ASTRALPLAGUE_API UScriptStruct* StaticStruct<FInputMappingContextAndPriority>()
{
...
template<> ASTRALPLAGUE_API UClass* StaticClass<UGameFeatureAction_AddInputContextMapping>()
{
	return UGameFeatureAction_AddInputContextMapping::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_NovaB_Desktop_AstralPlague_AstralPlague_Source_AstralPlague_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeatureAction_AddInputContextMapping, UGameFeatureAction_AddInputContextMapping::StaticClass, TEXT("UGameFeatureAction_AddInputContextMapping"), &Z_Registration_Info_UClass_UGameFeatureAction_AddInputContextMapping, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeatureAction_AddInputContextMapping), 1657217201U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_NovaB_Desktop_AstralPlague_AstralPlague_Source_AstralPlague_GameFeatures_GameFeatureAction_AddInputContextMapping_h_3324620541(TEXT("/Script/AstralPlague"),
	Z_CompiledInDeferFile_FID_Users_NovaB_Desktop_AstralPlague_AstralPlague_Source_AstralPlague_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_NovaB_Desktop_AstralPlague_AstralPlague_Source_AstralPlague_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_NovaB_Desktop_AstralPlague_AstralPlague_Source_AstralPlague_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_NovaB_Desktop_AstralPlague_AstralPlague_Source_AstralPlague_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
